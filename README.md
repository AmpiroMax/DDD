# DDD — Terraria-like MVP (C++20 / SFML / Box2D)

Минимальный “каркас” террария-подобной 2D-игры: ECS, фиксированный шаг физики, рендер через SFML, конфиги в JSON, тайловый мир, игрок, инвентарь/хотбар, дропы и меню/пауза.
...
- Базовый сценарий: открыть карту (demo `level_house`), бегать/прыгать, ломать/ставить блоки, дропы падают и подбираются, хотбар переключается wheel/цифрами, меню/пауза работают.
