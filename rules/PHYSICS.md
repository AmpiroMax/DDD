...
- Доп. задача: дроп сломанных объектов — по событиям ломки создавать физтела “дропа”, чтобы они падали рядом и лежали на ближайших блоках (как в Terraria).
...
- С Mechanics2 (инвентарь): событие “дроп подобран” может потребоваться; договориться о формате дропа.
